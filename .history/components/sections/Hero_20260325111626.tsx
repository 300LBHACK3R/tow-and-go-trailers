      ...
      <Container className="relative py-20 md:py-28">
        <div className="grid items-center gap-14 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-black/60 backdrop-blur-xl p-6 shadow-[0_20px_80px_rgba(0,0,0,0.6)]">
              ...
              <div className="grid gap-4">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/50 p-5">
                  ...
                  <p className="mt-2 text-sm text-zinc-300">
                    Perfect for cleanup, landscaping, and heavy loads.
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-[#d4af37]/40 bg-[#d4af37]/10 p-5">
                  ...
                  <p className="mt-2 text-sm text-zinc-200">
                    Expanding the fleet with a larger premium hauling option.
                  </p>
                </div>
              </div>
