          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-black/45 p-6 backdrop-blur-xl shadow-[0_30px_120px_rgba(0,0,0,0.70)]">
              ...
              <div className="grid gap-4">
                {/* Enclosed Trailer */}
                <div className="group overflow-hidden rounded-2xl border border-white/10 bg-black/45 transition hover:border-white/20">
                ...
                {/* Dovetail Trailer */}
                <div className="group overflow-hidden rounded-2xl border border-[#d4af37]/40 bg-[#d4af37]/10 transition hover:border-[#d4af37]/60">
                  <div className="grid grid-cols-[100px_1fr]">
                    <div className="relative min-h-[110px]">
                      <Image
