...
export function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-white/10 pt-[110px]">
      {/* BACKGROUND GLOW */}
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(212,175,55,0.08),transparent_22%),radial-gradient(circle_at_right,rgba(255,255,255,0.05),transparent_28%)]" />
        ...
        <div className="grid items-center gap-14 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="max-w-4xl">
            ...
            <h1 className="text-5xl font-bold leading-[0.95] tracking-tight text-white sm:text-6xl lg:text-7xl">
              Trailer Rentals
              <span className="block text-zinc-300">That Look Premium</span>
          ...
          <div className="relative">
            <div className="absolute -inset-6 rounded-[2rem] bg-[radial-gradient(circle,rgba(212,175,55,0.14),transparent_60%)] blur-2xl" />

            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-6 shadow-[0_20px_80px_rgba(0,0,0,0.45)]">
