    ...
    <header className="fixed inset-x-0 top-0 z-[100] border-b border-white/10 bg-black/85 backdrop-blur-xl">
      <Container className="flex h-[92px] items-center justify-between">
        ...
        <button
          ...
          className="rounded-xl p-2 text-white xl:hidden"
      ...
      {mobileOpen && (
        <div className="absolute left-0 right-0 top-[92px] z-[101] border-t border-white/10 bg-black/95 shadow-[0_20px_60px_rgba(0,0,0,0.5)] xl:hidden">
