    ...
    <header className="fixed inset-x-0 top-0 z-[100] border-b border-white/10 bg-black/85 backdrop-blur-xl">
      <Container className="flex h-[92px] items-center justify-between">
        ...
        <details className="relative xl:hidden">
          <summary className="list-none rounded-xl p-2 text-white cursor-pointer select-none">
            <span className="text-2xl leading-none">☰</span>
          </summary>

          <div className="absolute right-0 top-[56px] w-[280px] rounded-2xl border border-white/10 bg-black/95 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
