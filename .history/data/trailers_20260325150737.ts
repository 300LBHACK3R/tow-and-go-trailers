...
export const trailers: Trailer[] = [
  ...
  summary:
    "Heavy-duty flat deck built for real work.",
  description:
    "This 2026 Southland 7x20 + dovetail trailer with dual 7000lb axles is built for serious hauling. Ideal for equipment, vehicles, and larger loads with stability and strength you can rely on.",
  specs: [
    "7x20 deck + dovetail",
    "Dual 7000lb axles",
