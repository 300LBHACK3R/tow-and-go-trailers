export const trailers: Trailer[] = [
  {
    ...
    description:
      "This 2026 Royal Cargo 7'6\" x 16' + V-Nose enclosed trailer with dual 3500lb axles is a strong option for customers needing secure, weather-protected hauling. Ideal for moving, equipment transport, and clean enclosed storage on the road. This trailer is currently out on rent until the end of March.",
    specs: [
      "2026 Royal Cargo",
      `7'6" x 16' + V-Nose`,
      "Dual 3500lb axles",
